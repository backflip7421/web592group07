...
//3. แปลงเป็น json
 ...
 // 4. บันทึกลงไฟล์
		...
		?><br>SAVED !<a href='canon.php?p=$page' id='pagelink'>OK</a>
		<script>
...
<form method="post" action="">
	<div class="row">
		...
		<div class="col-xs-10">
			<label for="feedbackcanon"><?= $userdata['nick'] ?></label>
			<div class="input-group">
				<input type="text" class="form-control" placeholder="COMMENT" name="feedbackcanon">
